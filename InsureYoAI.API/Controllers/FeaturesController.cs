...
namespace InsureYoAI.API.Controllers
{
    ...
    [ApiController]
    public class FeaturesController(IFeatureService _service) : ControllerBase
    {
        [HttpGet]
        ...
        [HttpPost]
        public async Task<IActionResult> Create(CreateFeatureDto create)
        {
            await _service.CreateAsync(create);
            return Created();
        }
        [HttpPut]
        public async Task<IActionResult> Update(UpdateFeatureDto update)
        {
